...
function Service:PlayVFXAt( -- Maybe we can dumb this down to just a DOS search and then play VFX with specified parameters?
	...
	local PlrsNearNPC = {}
	local CharactersNearVFX = DOS.Tree:RadiusSearch(VFXPosition[1].WorldPosition, 50)
		or DOS.Tree:RadiusSearch(VFXPosition, 50)
		or DOS.Tree:RadiusSearch(VFXPosition.PrimaryPart.Position, 50)
